...
enum ENVIRONMENT_VARIABLES {
  ...
  NODE_ENV = 'NODE_ENV',
  MAILJETAPIPUBLICKEY='MAILJETAPIPUBLICKEY',
  MAILJETAPIPRIVATEKEY='MAILJETAPIPRIVATEKEY',
...
export const APP_CONFIGS = {
  ...
  MAILJETAPIPRIVATEKEY:getEnv(ENVIRONMENT_VARIABLES.MAILJETAPIPRIVATEKEY),
  MAILJETAPIPUBLICKEY: getEnv(ENVIRONMENT_VARIABLES.MAILJETAPIPUBLICKEY),
  PASSWORD_HASH_SECRET: getEnv(ENVIRONMENT_VARIABLES.PASSWORD_HASH_SECRET)
};
